"""``ward down`` — stop the workshop, freeing CPU and memory."""
...
def run() -> None:
    ...
    try:
        ...
        die(
            ...
            "[ERROR] Failed to shut down container 'ward'. Force execution "
    ...
    info("[INFO] Container 'ward' is now down.")
